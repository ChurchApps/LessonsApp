  ...
  return (
    <>
      <InputBox id="feedBox" headerText="Subscribe" headerIcon="rss_feed" saveFunction={handleCancel} saveText="Done">
        ...
        <p>
          See the bottom of this page for instructions on how to display lessons in your classroom using the
          Lesson.church app and get leader instructions via the B1.church app.
        </p>
        <b>Use with Digital Signage</b>
        <p>
          For use with external digital signage software, right click and copy{" "}
          <a href={getFeedUrl()} target="_blank" rel="noreferrer nooppener">
            this url
          </a>
          . Follow{" "}
          <a
            href="https://support.signpresenter.com/topics/lessons-dot-church.html"
            target="_blank"
            rel="noreferrer nooppener">
            these instructions
          </a>{" "}
          to connect to SignPresenter.
        </p>
        <b>Share Your Current Lesson</b>
        <p>
          Link to{" "}
          <a href={getClassroomUrl()} target="_blank" rel="noreferrer nooppener">
            this page
          </a>{" "}
        ...
        <p>
          Share{" "}
          <a href={getClassroomUrl() + "?upcoming=1"} target="_blank" rel="noreferrer nooppener">
            this page
          </a>{" "}
          with teachers for upcoming lessons.
        </p>
      </InputBox>
    </>
  );

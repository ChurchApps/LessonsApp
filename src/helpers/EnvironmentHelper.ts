...
export class EnvironmentHelper {
  ...
  static initStaging = () => { EnvironmentHelper.LessonsApi = process.env.NEXT_PUBLIC_LESSONS_API || "https://api.staging.lessons.church"; };

  //NOTE: None of these values are secret.
  static initProd = () => { EnvironmentHelper.LessonsApi = process.env.NEXT_PUBLIC_LESSONS_API || "https://api.lessons.church"; EnvironmentHelper.Common.GoogleAnalyticsTag = "G-JQWWX8YS7F"; };
}

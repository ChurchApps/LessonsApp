...
import { ArrayHelper, Banner, ChurchInterface, DateHelper, DisplayBox, InputBox } from "@churchapps/apphelper";
        ...
        <Grid container spacing={3}>
          <Grid item md={8} xs={12}>
            <DisplayBox headerText="Unique Downloads by Study" headerIcon="bar_chart">
              <p style={{ marginTop: 0 }}>
                Note: These are <u>unique</u> counts. A person may download multiple files within a lesson, download a
                lesson multiple times, or download multiple lessons within a series. All of these scenarios counts as a

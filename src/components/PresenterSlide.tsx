...
export function PresenterSlide(props: Props) {
  ...
  if (url.startsWith("vimeo:")) {
    ...
    result = <>
      <iframe src={"https://player.vimeo.com/video/" + vimeoId + "?h=ceb1d1ff2b&autoplay=1&title=0&byline=0&portrait=0"} style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%" }} allow="autoplay; fullscreen" allowFullScreen></iframe>

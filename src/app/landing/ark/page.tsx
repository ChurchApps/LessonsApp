        ...
        <Container fixed>
          <Grid container spacing={4}>
            ...
            <Grid item md={4} xs={12} style={{ textAlign: "center" }}>
              <p style={{ minHeight: 100, fontStyle: "italic" }}>Lessons.church provides fun, biblical lessons with materials designed for different age groups, allowing families to discuss the same lesson together.</p>

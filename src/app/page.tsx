...
const loadData = async () => {
  ...
  const stats: { churchCount: number; lessonCount: number; studyCount: number; programCount: number } =
    await ApiHelper.getAnonymous("/providers/stats", "LessonsApi", ["all"]);
      ...
      <Grid item md={2} sm={4} xs={4}>
        <Link href="/high-voltage">
          <Image
            ...
            placeholder="empty"
            className="img-fluid"
            src="https://content.lessons.church/programs/yBl-EUBxm17.png?dt=1625530793952"
          />
        </Link>
      </Grid>
      <Grid item md={2} sm={4} xs={4}>
        <Link href="/faith-kidz">
          <Image
            ...
            placeholder="empty"
            className="img-fluid"
            src="https://content.lessons.church/programs/CMCkovCA00e.png?dt=1724178996201"
          />
        </Link>
      </Grid>
      <Grid item md={2} sm={4} xs={4}>
        <Link href="/west-ridge">
          <Image
            ...
            placeholder="empty"
            className="img-fluid"
            src="https://content.lessons.church/programs/CjDN3VrEm3s.png?dt=1695316859942"
          />
        </Link>
      </Grid>
    </>

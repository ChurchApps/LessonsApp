        ...
        <div className="apps">
          <Grid container justifyContent="center" spacing={3}>
            ...
            <Grid size={{ md: 6, xs: 12 }}>
              ...
              <Stack direction="row" spacing={2}>
                <a href="https://play.google.com/store/apps/details?id=church.b1.mobile">
                  <img src="/images/apps/google.png" alt="Google Play" className="img-fluid" />
                </a>
                <a href="https://apps.apple.com/us/app/b1-church/id1610587256">
                  <img src="/images/apps/apple.png" alt="Apple App Store" className="img-fluid" />
                </a>
              </Stack>
            </Grid>
          </Grid>
